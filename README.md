...
ClojureScript build. See `dev/nwestallen/sci_extensions.cljs` for more
information.
...
```clj
(clerk/show! "notebooks/nwestallen/mathnotes.clj")
```
...
All ClojureScript code you add to `src/nwestallen/custom.cljs` is available
for use inside any [custom viewer code you
write](https://book.clerk.vision/#writing-viewers).

This is made possible by the code in `src/nwestallen/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `nwestallen` and the project name is `mathnotes`.
...
git branch -M main
git remote add origin git@github.com:nwestallen/mathnotes.git
git push -u origin main
```

Then visit https://github.com/nwestallen/mathnotes to see your site.
...
By default your site will live at https://nwestallen.github.io/mathnotes.
...
https://github.clerk.garden/nwestallen/mathnotes
