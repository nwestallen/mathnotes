(ns nwestallen.sci-extensions
    (:require [nwestallen.custom]
              [emmy.sci]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns nwestallen.custom
               (sci/create-ns 'nwestallen.custom)))
...
(def custom-namespaces
  {'nwestallen.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [nwestallen.custom :as custom])`
(def custom-aliases
  {'custom 'nwestallen.custom})
